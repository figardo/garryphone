...
function GM:CreatePromptScreen()
	...
	local placeholder = firstPrompt and language.GetPhrase("GarryPhone.eg") .. " " .. examples[math.random(#examples)] or language.GetPhrase("GarryPhone.Type"):format(input.LookupBinding("+menu"))
